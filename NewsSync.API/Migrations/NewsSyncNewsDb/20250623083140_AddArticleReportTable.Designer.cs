...
namespace NewsSync.API.Migrations.NewsSyncNewsDb
{
    ...
    [Migration("20250623083140_AddArticleReportTable")]
    partial class AddArticleReportTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArticleReport", b =>
                {
                    ...
                    b.HasIndex("ArticleId", "ReportedByUserId")
                        .IsUnique();

                    b.ToTable("ArticleReport");
                });

            modelBuilder.Entity("NewsSync.API.Models.Domain.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ArticleReport", b =>
                {
                    ...
                    b.HasOne("NewsSync.API.Models.Domain.AppUser", "ReportedByUser")
                        .WithMany()
